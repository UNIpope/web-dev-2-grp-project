<!-- 
	...
	Purpose: Display the ice cream of the shop
	Authors: Jack Duggan + Buchita Gitchamnan	
	Reference: www.w3schools.com, www.getbootstrap.com
-->
...
<head>
	...
	<style type="text/css">
		body
		{
		    ...
		    background-color: #FEEAF4; /*pastel pink*/


		}
		.jumbotron
		{
			background-color: #E1FFFD; /*blue*/
		}
	</style>
