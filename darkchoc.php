...
<head>
	...
	<style type="text/css">
		body
		{
		    ...
		    background-color: #43210a;  /*brown*/


		}
		.jumbotron
		{
			background-color: #eda376; /*lightbrown*/
		}
	</style>
				...
				<div class="col-sm-6">
					<div class="jumbotron">
						...
						<form class="form-horizontal" method="post" action="IceCreamMenuData.php">
							...
							<input type="hidden" name="name" value="darkchoc">
							

							<div class="form-group">
								<label class="control-label col-sm-2" for="price">Price:&euro;1.50 </label>
